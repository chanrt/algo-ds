...
public:
    ...
    int decrease(int key, int value)
    {
        for(int i = 0; i < size; i++)
        {
            if(heap[i] == key)
...
int main()
{
    ...
    while (1)
    {
        ...
        printf("7. Print priority order\t8. Decrease element value\n");
        printf("\nEnter your choice: ");
        scanf("%d", &choice);
        ...
        else if(choice == 8)
        {
            ...
            {
                int key, value;
                printf("Enter element whose value should be decreased: ");
                scanf("%d",&key);
                printf("Enter decrease: ");
                scanf("%d",&value);
                
                if(queue.decrease(key, value))
                    printf("Value of element %d decreased to %d", key, key-value);
                else
